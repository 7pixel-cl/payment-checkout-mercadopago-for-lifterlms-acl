...
define ('PAYMENT_CHECKOUT_MERCADOPAGO_FOR_LIFTERLMS_ACL_MIN_LIFTERLMS_VERSION', '7.2.0');

define ('PAYMENT_CHECKOUT_MERCADOPAGO_FOR_LIFTERLMS_ACL_FILE', __FILE__);

define ('PAYMENT_CHECKOUT_MERCADOPAGO_FOR_LIFTERLMS_ACL_SLUG', 'payment-checkout-mercadopago-for-lifterlms-acl');

define ('PAYMENT_CHECKOUT_MERCADOPAGO_FOR_LIFTERLMS_ACL_DIR', plugin_dir_path(PAYMENT_CHECKOUT_MERCADOPAGO_FOR_LIFTERLMS_ACL_FILE));

define ('PAYMENT_CHECKOUT_MERCADOPAGO_FOR_LIFTERLMS_ACL_URL', plugin_dir_url(PAYMENT_CHECKOUT_MERCADOPAGO_FOR_LIFTERLMS_ACL_FILE));

define ('PAYMENT_CHECKOUT_MERCADOPAGO_FOR_LIFTERLMS_ACL_BASENAME', plugin_basename(PAYMENT_CHECKOUT_MERCADOPAGO_FOR_LIFTERLMS_ACL_FILE));
